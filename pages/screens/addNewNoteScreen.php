...
$valAjouter = $admin->addNewNoteUniteEn(connexionDb(), $_FILES, $admin->getIdAdministrateur(), $_GET['idEtablissement']);
?>
<!DOCTYPE html>
<html lang="fr">
            ...
            <div class="container">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                            <h4>Ajout Note Selectionner un fichier au format '.CSV'</h4><br>
